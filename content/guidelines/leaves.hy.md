...
[extra]
status = "caution"
title = "Տերևների հեռացում"
verdict_short = "Պարտադիր կոմպոստացում"
description = "Ականող ցեցով վարակվածության պատճառով տերևները պետք է կոմպոստացնել՝ վնասատուներին ոչնչացնելու համար: Մի թողեք դրանք հողի մակերեսին:"
+++
