...
**The Standard.**
Kanach Yerevan advocates for a strict prohibition on topping for public trees. Instead, we must adopt international best practices that focus on structural pruning and canopy preservation. Maintenance should be performed by trained specialists using certified arboriculture techniques to maintain the tree's natural form. This shift will ensure a safer, cooler, and more sustainable green canopy for our city.

**Current status.**
Topping is the main method of cutting trees currently in use by the city in public areas, with proper cutting practices only observable on private property.
