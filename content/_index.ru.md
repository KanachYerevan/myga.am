...
template = "home.html"
+++
**Kanach Yerevan** — это общественное движение, цель которого — сделать Ереван более зеленым, устойчивым и пригодным для жизни городом.
Мы достигаем этого, организуя картографические мероприятия, проводя мозговые штурмы и повышая осведомленность о важности городского озеленения через публичные лекции.
...
- [Сборник правил по уходу за деревьями](/codes/)

## Следите за нами

- [Приложение для картирования](https://yerevan.treemaps.app/)
- [Instagram](https://instagram.com/kanach.yerevan)
- [Telegram канал](https://t.me/kanachyerevan) и [чат](https://t.me/make_yerevan_green_again)
- [YouTube канал](https://youtube.com/@YerevanObserver)
